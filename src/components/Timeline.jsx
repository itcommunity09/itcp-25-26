...
export default function Timeline() {
    return (
        <div className="w-full flex justify-center items-start text-white py-12 px-5 gap-4">
            ...
            <img src={day1} alt="day1" className="absolute w-[27px] -mt-2 -ml-92 md:w-[58px] md:-mt-2 md:-ml-180  lg:-ml-190 z-10"/>
            <img src={day2} alt="day2" className="absolute w-[26px] mt-58 -ml-92 md:w-[60px] md:mt-120 md:-ml-180 lg:-ml-190  z-10"/>
